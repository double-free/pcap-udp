...
def compare_snapshot(snapshot1, snapshot2):
    if snapshot1[5:] == snapshot2[5:]:
        return True
    # nasty, probably the float precision?
    return abs(float(snapshot1[10]) - float(snapshot2[10])) < 1e-5
...
def in_gap(bench_line) -> bool:
    ...
    gaps = [
        ...
        [1587611462.9860, 1587611463.46868],# for snapshot 300335~300346
        [1587611463.46873, 1587611463.4690], # 111018620 to 111019110
        [1587611463.4691, 1587611463.4694], # for snapshot 300330,300336,300338
        [1587611463.4695, 1587611463.4700], # for 2 trades

        [1587611463.7217, 1587611463.7351], # 111019360 to 111019370
        [1587611464.9602, 1587611465.2864], # 111020600 to 111020920
        [1587611465.4944, 1587611465.91358],# 111021130 to 111021560
        [1587611465.913657, 1587611465.920464], # for snapshot 000628~000650
        [1587611466.0646, 1587611466.5426], # for snapshot 300563~300585
        [1587611466.5428, 1587611466.548646], # 111021700 to 111022190
        ...
        [1587611816.9259, 1587611817.33097], # for snapshot 300084, 300088
        [1587611817.3310, 1587611817.3476], # 111612560 to 111612980
